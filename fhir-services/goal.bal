...
# bound to port `9098`.
service /fhir/r4 on new fhirr4:Listener(9098, goalApiConfig) {
    ...
    isolated resource function get Goal(r4:FHIRContext fhirContext) returns r4:Bundle|r4:OperationOutcome|r4:FHIRError|error {
        return filterGoalData(fhirContext);
    }
    ...
    isolated resource function post Goal/_search(r4:FHIRContext fhirContext) returns r4:FHIRError|http:Response {
        r4:Bundle|error result = filterGoalData(fhirContext);
...
isolated function filterGoalData(r4:FHIRContext fhirContext) returns r4:FHIRError|r4:Bundle|error {
