...
service /fhir/r4/Group on new fhirr4:Listener(config = apiConfig) {

    // Implementation of the $export operation
    isolated resource function get [string id]/\$export(r4:FHIRContext fhirContext) returns r4:FHIRError|r4:OperationOutcome|error {
